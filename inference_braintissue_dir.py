...
def test(dir):
    hcppath='/home/xuesheng3/liuyuchen/Data/Datasets/Task01_BrainTissueHCP/labelsTs'
    ixipath='/home/xuesheng3/liuyuchen/Data/Datasets/Task02_BrainTissueIXI/labelsTs'    
    saldpath='/home/xuesheng3/liuyuchen/Data/Datasets/Task03_BrainTissueSALD/labelsTs'    
    ibsrpath='/home/xuesheng3/liuyuchen/Data/Datasets/Task004_BrainTissueIBSRTVT/test/label'        
    path = '/home/xuesheng3/liuyuchen/Data/nnSegnext_raw_data_base/Infer/'
    # dir='HCP_HCP'
    filelist  = os.listdir(path+dir)
    for  file in  filelist:
        if os.path.isdir(f'{path+dir}/{file}'):
            # if file == 'nnformers_IBSR_IBSR':
                acc = file.split('_')[1]
                # if not os.path.exists(f'{os.path.join(path+dir,file)}/dice_pre.txt'):
                print(acc)
                label_list=sorted(glob.glob(os.path.join(ibsrpath,'*nii.gz')))
...
if __name__ == '__main__':
    ...
    parser.add_argument("-dir",default='IBSR/IBSR_IBSR', help="fold name")
