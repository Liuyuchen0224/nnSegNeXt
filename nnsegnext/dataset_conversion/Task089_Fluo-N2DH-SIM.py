...
if __name__ == "__main__":
    ...
    output_raw = join(nnSegnext_raw_data, full_taskname)
    shutil.rmtree(output_raw)
    shutil.copytree(join(nnSegnext_raw_data, 'Task999_Fluo-N2DH-SIM_thickborder'), output_raw)

    shutil.rmtree(join(nnSegnext_raw_data, 'Task999_Fluo-N2DH-SIM_thickborder'))
