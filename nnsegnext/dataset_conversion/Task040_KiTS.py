...
def copy_npz_fom_valsets():
    ...
    folders = ['nnSegnextTrainerNewCandidate23_FabiansPreActResNet__nnSegnextPlans',
               'nnSegnextTrainerNewCandidate23_FabiansResNet__nnSegnextPlans',
               'nnSegnextTrainerNewCandidate23__nnSegnextPlans']
    for f in folders:
...
def ensemble(experiments=('nnSegnextTrainerNewCandidate23_FabiansPreActResNet__nnSegnextPlans',
               'nnSegnextTrainerNewCandidate23_FabiansResNet__nnSegnextPlans'), out_dir="/media/fabian/Results/nnSegnext/3d_lowres/Task048_KiTS_clean/ensemble_preactres_and_res"):
    from nnsegnext.inference.ensemble_predictions import merge
...
def prepare_submission(fld= "/home/fabian/drives/datasets/results/nnSegnext/test_sets/Task048_KiTS_clean/predicted_ens_3d_fullres_3d_cascade_fullres_postprocessed", # '/home/fabian/datasets_fabian/predicted_KiTS_nnSegnextTrainerNewCandidate23_FabiansResNet',
                       out='/home/fabian/drives/datasets/results/nnSegnext/test_sets/Task048_KiTS_clean/submission'):
...
def pretent_to_be_nnSegnextTrainer(base, folds=(0, 1, 2, 3, 4)):
    """
    changes best checkpoint pickle nnsegnexttrainer class name to nnSegnextTrainer
    :param experiments:
    :return:
    """
    for fold in folds:
...
def nnSegnextTrainer_these(experiments=('nnSegnextTrainerNewCandidate23_FabiansPreActResNet__nnSegnextPlans',
               'nnSegnextTrainerNewCandidate23_FabiansResNet__nnSegnextPlans',
               'nnSegnextTrainerNewCandidate23__nnSegnextPlans')):
    """
    changes best checkpoint pickle nnsegnexttrainer class name to nnSegnextTrainer
    ...
    for exp in experiments:
        cur = join(base, exp)
        pretent_to_be_nnSegnextTrainer(cur)


def reset_trainerName_these(experiments=('nnSegnextTrainerNewCandidate23_FabiansPreActResNet__nnSegnextPlans',
               'nnSegnextTrainerNewCandidate23_FabiansResNet__nnSegnextPlans',
               'nnSegnextTrainerNewCandidate23__nnSegnextPlans')):
    """
    changes best checkpoint pickle nnsegnexttrainer class name to nnSegnextTrainer
...
if __name__ == "__main__":
    ...
    out = "/media/fabian/My Book/MedicalDecathlon/nnSegnext_raw_splitted/Task040_KiTS"
    ...
    json_dict['reference'] = "KiTS data for nnsegnext"
    json_dict['licence'] = ""
