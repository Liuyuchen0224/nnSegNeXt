...
from nnsegnext.paths import preprocessing_output_dir, nnSegnext_raw_data
from nnsegnext.utilities.sitk_stuff import copy_geometry
...
def convert_variant2_predicted_test_to_submission_format(folder_with_predictions,
                                                         output_folder="/home/fabian/drives/datasets/results/nnSegnext/test_sets/Task038_CHAOS_Task_3_5_Variant2/ready_to_submit",
                                                         postprocessing_file="/home/fabian/drives/datasets/results/nnSegnext/ensembles/Task038_CHAOS_Task_3_5_Variant2/ensemble_2d__nnSegnextTrainerV2__nnSegnextPlansv2.1--3d_fullres__nnSegnextTrainerV2__nnSegnextPlansv2.1/postprocessing.json"):
    """
    ...
    :return:
    """
    postprocessing_file = "/media/fabian/Results/nnSegnext/3d_fullres/Task039_CHAOS_Task_3_5_Variant2_highres/" \
                          "nnSegnextTrainerV2__nnSegnextPlansfixed/postprocessing.json"
    ...
    from nnsegnext.postprocessing.connected_components import apply_postprocessing_to_folder, load_postprocessing
