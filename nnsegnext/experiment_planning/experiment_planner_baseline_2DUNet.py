...
from nnsegnext.experiment_planning.common_utils import get_pool_and_conv_props
from nnsegnext.experiment_planning.experiment_planner_baseline_3DUNet import ExperimentPlanner
from nnsegnext.experiment_planning.utils import add_classes_in_slice_info
from nnsegnext.network_architecture.generic_UNet import Generic_UNet
from nnsegnext.paths import *
from nnsegnext.preprocessing.preprocessing import PreprocessorFor2D
...
class ExperimentPlanner2D(ExperimentPlanner):
    def __init__(self, folder_with_cropped_data, preprocessed_output_folder):
        ...
        self.plans_fname = join(self.preprocessed_output_folder, "nnSegnextPlans" + "_plans_2D.pkl")
