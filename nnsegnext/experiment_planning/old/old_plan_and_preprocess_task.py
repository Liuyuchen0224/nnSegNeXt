...
from nnsegnext.experiment_planning.utils import split_4d, crop, analyze_dataset, plan_and_preprocess
...
if __name__ == "__main__":
    ...
    if task == "all":
        all_tasks = subdirs(nnSegnext_raw_data, prefix="Task", join=False)
        for t in all_tasks:
        ...
        if not use_splitted or not isdir(join(nnSegnext_raw_data, task)):
