...
from nnsegnext.paths import nnSegnext_raw_data, nnSegnext_cropped_data
import numpy as np
import pickle
from nnsegnext.preprocessing.cropping import get_patient_identifiers_from_cropped_files
