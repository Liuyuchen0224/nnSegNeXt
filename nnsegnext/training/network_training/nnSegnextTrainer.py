...
from nnsegnext.training.dataloading.dataset_loading import load_dataset, DataLoader3D, DataLoader2D, unpack_dataset
from nnsegnext.training.loss_functions.dice_loss import DC_and_CE_loss,DC_and_CE_wED_loss
from nnsegnext.training.network_training.network_trainer import NetworkTrainer
...
class nnSegnextTrainer(NetworkTrainer):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
        ...
        IMPORTANT: If you inherit from nnSegnextTrainer and the init args change then you need to redefine self.init_args
        in your init accordingly. Otherwise checkpoints won't load properly!
        """
        super(nnSegnextTrainer, self).__init__(deterministic, fp16)
    ...
    def run_training(self):
        ...
        super(nnSegnextTrainer, self).run_training()
    ...
    def preprocess_patient(self, input_files):
        ...
        preprocessor_class = recursive_find_python_class([join(nnsegnext.__path__[0], "preprocessing")],
                                                         preprocessor_name,
                                                         current_module="nnsegnext.preprocessing")
        assert preprocessor_class is not None, "Could not find preprocessor %s in nnsegnext.preprocessing" % \
                                               preprocessor_name
    ...
    def save_checkpoint(self, fname, save_optimizer=True):
        super(nnSegnextTrainer, self).save_checkpoint(fname, save_optimizer)
        info = OrderedDict()
