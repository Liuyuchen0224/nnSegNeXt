...
import numpy as np
from nnsegnext.training.loss_functions.deep_supervision import MultipleOutputLoss2
from nnsegnext.training.network_training.nnSegnextTrainerV2 import nnSegnextTrainerV2
...
class nnSegnextTrainerV2CascadeFullRes(nnSegnextTrainerV2):
    def __init__(self, plans_file, fold, output_folder=None, dataset_directory=None, batch_dice=True, stage=None,
                 unpack_data=True, deterministic=True, previous_trainer="nnSegnextTrainerV2", fp16=False):
