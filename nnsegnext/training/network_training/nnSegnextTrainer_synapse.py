...
from nnsegnext.training.loss_functions.dice_loss import DC_and_CE_loss
from nnsegnext.training.network_training.network_trainer_synapse import NetworkTrainer
...
class nnSegnextTrainer_synapse(NetworkTrainer):
