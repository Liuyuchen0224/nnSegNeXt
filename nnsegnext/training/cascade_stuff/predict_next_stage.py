...
import argparse
from nnsegnext.preprocessing.preprocessing import resample_data_or_seg
...
if __name__ == "__main__":
    ...
    trainer_class = recursive_find_python_class([join(nnsegnext.__path__[0], "training", "network_training")],
                                                trainerclass,
                                                "nnsegnext.training.network_training")
