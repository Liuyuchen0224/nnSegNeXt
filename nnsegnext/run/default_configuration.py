...
from nnsegnext.experiment_planning.summarize_plans import summarize_plans
...
def get_default_configuration(network, task, network_trainer, plans_identifier=default_plans_identifier,
                              search_in=(nnsegnext.__path__[0], "training", "network_training"),
                              base_module='nnsegnext.training.network_training'):
    ...
    print("###############################################")
    print("I am running the following nnSegnext: %s" % network)
