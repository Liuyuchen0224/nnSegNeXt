...
if __name__ == "__main__":
    ...
    overwrite_plans = {
        'nnSegnextTrainerV2_2': ["nnSegnextPlans", "nnSegnextPlans_customClip"], # r
        'nnSegnextTrainerV2_2_noMirror': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r
        'nnSegnextTrainerV2_lessMomentum_noMirror': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r
        'nnSegnextTrainerV2_2_structSeg_noMirror': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r
        'nnSegnextTrainerV2_2_structSeg': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r
        'nnSegnextTrainerV2_lessMomentum_noMirror_structSeg': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r
        'nnSegnextTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r
        'nnSegnextTrainerV2_FabiansResUNet_structSet_NoMirror': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r
        'nnSegnextTrainerV2_FabiansResUNet_structSet': ["nnSegnextPlans", "nnSegnextPlans_customClip"],  # r

    }

    trainers = ['nnSegnextTrainer'] + [
        'nnSegnextTrainerV2_2',
        'nnSegnextTrainerV2_lessMomentum_noMirror',
        'nnSegnextTrainerV2_2_noMirror',
        'nnSegnextTrainerV2_2_structSeg_noMirror',
        'nnSegnextTrainerV2_2_structSeg',
        'nnSegnextTrainerV2_lessMomentum_noMirror_structSeg',
        'nnSegnextTrainerV2_FabiansResUNet_structSet_NoMirror_leakyDecoder',
        'nnSegnextTrainerV2_FabiansResUNet_structSet_NoMirror',
        'nnSegnextTrainerV2_FabiansResUNet_structSet',
    ]
