...
if __name__ == "__main__":
    ...
    plans = "nnSegnextPlansv2.1"

    overwrite_plans = {
        'nnSegnextTrainerCascadeFullRes': ['nnSegnextPlans'],
    }

    trainers = [
        'nnSegnextTrainerCascadeFullRes',
        'nnSegnextTrainerV2CascadeFullRes_EducatedGuess',
        'nnSegnextTrainerV2CascadeFullRes_EducatedGuess2',
        'nnSegnextTrainerV2CascadeFullRes_EducatedGuess3',
        'nnSegnextTrainerV2CascadeFullRes_lowerLR',
        'nnSegnextTrainerV2CascadeFullRes',
        'nnSegnextTrainerV2CascadeFullRes_noConnComp',
        'nnSegnextTrainerV2CascadeFullRes_shorter_lowerLR',
        'nnSegnextTrainerV2CascadeFullRes_shorter',
        'nnSegnextTrainerV2CascadeFullRes_smallerBinStrel',
        #'',
        #'',
        #'',
        #'',
