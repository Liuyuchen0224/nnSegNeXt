...
from nnsegnext.experiment_planning.utils import split_4d
from nnsegnext.utilities.file_endings import remove_trailing_slash
...
def main():
    ...
    parser = argparse.ArgumentParser(description="The MSD provides data as 4D Niftis with the modality being the first"
                                                 ...
                                                 "expects")
    parser.add_argument("-i", default='/home/xuesheng3/liuyuchen/Data/Datasets/Task03_BrainTissueSALD',help="Input folder. Must point to a TaskXX_TASKNAME folder as downloaded from the MSD "
